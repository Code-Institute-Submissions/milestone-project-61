function loadMap(mapClientType, mapGroupType, mapDays, mapWater){
    ...
    require(["esri/Map", "esri/WebScene","esri/views/SceneView","esri/widgets/BasemapToggle", "esri/widgets/BasemapGallery", "esri/Graphic", "esri/layers/GraphicsLayer", "esri/widgets/Sketch", "esri/symbols/PolygonSymbol3D","esri/symbols/ExtrudeSymbol3DLayer"],
        function(Map, WebScene, SceneView, BasemapToggle, BasemapGallery, Graphic, GraphicsLayer, Sketch, PolygonSymbol3D, ExtrudeSymbol3DLayer, HQgraphic){
            ...
            //marker objects
            hqMarker = new ConstructMarker (-3.340692, 57.007759, "hq", 30, 45, "Cairngorms Outdoors HQ, Invercauld Road, Braemar, AB35 5XR", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/hq.jpg");
            campMarker1 = new ConstructMarker (-3.668879, 57.070710, "camp", 30, 45,  "Camp on the summit of Ben Macdui", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/camp1.gif");
            campMarker2 = new ConstructMarker (-4.042070, 56.944850, "camp", 30, 45, "Camp on the beach of Loch an T-Seilich", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/camp2.gif");
            waterMarker1 = new ConstructMarker (-3.674994, 57.020003, "water", 30, 45, "Paddle down the river Dee", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/riverDee.gif");
            waterMarker2 = new ConstructMarker (-4.043326, 56.989550, "water", 30, 45,"Paddle down the wild River Tromie", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/riverTromie.gif");
            waterMarker3 = new ConstructMarker (-4.248634, 56.927478, "water", 30, 45,"Travel 14 miles along Loch Ericht by power boat", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/boatEricht.png");
            pickupMarker1 = new ConstructMarker (-3.615609, 56.977300, "van", 30, 45,"Pickup Point: River Dee", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/pickup.jpg");
            pickupMarker2 = new ConstructMarker (-4.042070, 56.944850, "van", 30, 45,"Pickup Point: Gaick Lodge", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/pickup2.jpg");
            pickupMarker3 = new ConstructMarker (-4.248634, 56.927478, "van", 30, 45,"Pickup Point: Loch Ericht", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/pickup3.jpg");
            pickupMarker3Water = new ConstructMarker (-4.438334, 56.733432, "van", 30, 25, "Pickup Point: Loch Ericht", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/pickup3.jpg");
            ridgeMarker1 = new ConstructMarker (-3.450130, 57.066026, "photo", 25, 25, "Walk along the thin ridges of the Cairngorms peaks", "https://mvmolloy.github.io/workspace/milestone-project-2/assets/img/map-img/ridge1.png");
            ridgeMarker2 = new ConstructMarker (-3.644826, 57.070512, "photo", 25, 25, "Climb higher into the Cairngorms", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/ridge2.jpg");
            lochMarker1 = new ConstructMarker (-3.644826, 57.070512, "photo", 25, 25, "Take in the beautiful views of the loch below", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/loch1.jpg");
            ridgeMarker3 = new ConstructMarker (-3.450130, 57.066026, "photo", 25, 25, "Stop and take in the views along the thin ridges of the cairngorms peaks", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/ridge3.jpg");
            forestMarker1 = new ConstructMarker (-3.914447, 57.060672, "photo", 25, 25, "Get lost among the trees", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/forest1.jpg");
            peakMarker1 = new ConstructMarker (-3.728852, 57.077996, "photo", 25, 25, "See the wide skies from the peak of Braeriach", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/peak1.jpg");
            peakMarker2 = new ConstructMarker (-3.710913, 57.054314, "photo", 25, 25, "Look down on Loch Dee from the peak of Cairn Toul", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/peak2.jpg");
            riverMarker1 = new ConstructMarker (-3.622516, 56.977664, "photo", 25, 25, "Nearly there!", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/rivermarker1.gif");
            riverMarker2 = new ConstructMarker (-3.622516, 56.977664, "photo", 25, 25, "All river adventures should end with a smile", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/rivermarker2.gif");
            riverMarker3 = new ConstructMarker (-3.622516, 56.977664, "photo", 25, 25, "Be prepared for the River Dee to be a little wild", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/rivermarker3.gif");
            noWaterMarker1 = new ConstructMarker (-3.673897, 57.017884, "photo", 25, 25, "Walk along the bank of the wild River Dee", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/nowater1.jpg");
            noWaterMarker2 = new ConstructMarker (-4.043326, 56.989550, "photo", 25, 25, "Walk along tte bank of the wild River Tromie", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/nowater2.jpg"); 
            abseilMaker1 = new ConstructMarker (-3.785170, 57.060123, "photo", 25, 25, "Abseil into the crater of Loch Eniach", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/abseil1.jpg");
            climbMarker1 = new ConstructMarker (-3.796557, 57.060693, "photo", 25, 25, "Time to climb back out of Loch Eniach", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/climb1.jpg");
            riverMarker4 = new ConstructMarker (-4.036075, 56.967650, "photo", 25, 25, "Nearly there!", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/rivermarker1.gif");
            riverMarker5 = new ConstructMarker (-4.036075, 56.967650, "photo", 25, 25, "All river adventures should end with a smile", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/rivermarker2.gif");
            riverMarker6 = new ConstructMarker (-4.036075, 56.967650, "photo", 25, 25,  "Be prepared for the River Tromie to be a little wild", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/rivermarker3.gif");
            gorgeMarker = new ConstructMarker (-4.091434, 56.916269, "photo", 25, 25, "If we can't go over it, under it, or round it, we'll have to go through it", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/gorge1.jpg");
            ridgeMarker4 = new ConstructMarker (-4.066483, 56.937980, "photo", 25, 25, "Time for one more peak", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/ridge4.jpg");
            ridgeMarker5 = new ConstructMarker (-4.066483, 56.937980, "photo", 25, 25, "Time for one more peak", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/ridge5.jpg");
            lochMarker2 = new ConstructMarker (-4.192225, 56.904190, "photo", 25, 25, "Take in the views of the huge loch Ericht", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/loch2.jpg");
            lochMarker3 = new ConstructMarker (-4.387887, 56.821188, "photo", 25, 25, "Pause in the middle of Loch Ericht and take in the views", "https://mvmolloy.github.io/milestone-project-2/assets/img/map-img/loch3.jpg");
